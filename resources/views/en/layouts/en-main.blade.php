...
<head>
    ...
    <!-- CSS & Fonts -->
    <link rel="stylesheet" href='{!! asset("en-assets/css/bootstrap.min.css") !!}'>
    <link rel="stylesheet" href='{!! asset("en-assets/css/bootstrap-theme.min.css") !!}'>
    <link rel="stylesheet" href='{!! asset("en-assets/css/swiper.css") !!}'>
    <link rel="stylesheet" href='{!! asset("en-assets/css/jquery-ui.css") !!}'>
    <link rel="stylesheet" href='{!! asset("en-assets/css/style.css") !!}'>
    <link rel="stylesheet" href='{!! asset("en-assets/css/responsive.css") !!}'>
    <link rel="stylesheet" href='{!! asset("en-assets/css/animate.css") !!}'>
    ...
    <script src='{!! asset("en-assets/js/jquery-ui.js") !!}'></script>
    <script src='{!! asset("en-assets/js/bootstrap.min.js") !!}'></script>
    <script src='{!! asset("en-assets/js/wow.js") !!}'></script>
    <script src='{!! asset("en-assets/js/scripts.js") !!}'></script>
</head>
...
<body>
    <header>
        ...
        <nav>
            <div class="logo" style="margin-right:0px;"><img src='{!! asset("assets/images/logo-en.jpg") !!}' alt="Logo"></div>
            <div class="all-left">
                ...
                <div class="drop-nav">
                    ...
                    <ul class="left-nav">
                    @if (Auth::guest())
                        <li><a href='{!! URL::to("person-reg") !!}'>Person register</a></li>
                        <li><a href='{!! URL::to("register") !!}'>Company register</a></li>
                        <li class="account"><a href='{!! URL::to("dash") !!}'><i class="fa fa-user"></i>Login</a></li>
                    @else
                    <li class="account"><a href='{!! URL::to("jobs-edit") !!}'><i class="fa fa-user"></i>My account</a></li>
                    <li class="account"><a href='{!! URL::to("logout") !!}'><i class="fa fa-user"></i>Logout</a></li>
                    @endif
                        <li>
        ...
        <div class="no-select search-header">
            {!! Form::open(["url"=>"search", "method"=>"get"]) !!}
                ...
                <select name="country" id="country" required>
                    ...
                    <option value="all">All</option>
                     @foreach($country_en as $id=>$country)

            ...
            <div class="content col-lg-9 col-md-9 col-sm-9">
                ...
                <?php foreach($rank_search as $r_job): ?>
                    <li class="wow fadeIn" data-wow-delay=".2s" data-wow-duration="1s">
                        ...
                        <img  src='<?php echo asset("$r_job->image"); ?>'  alt="<?php echo $r_job->ar_title; ?>"></a>
                        <div class="free">
                            <a href='<?php echo URL::to("jobs/$r_job->id"); ?>'>
                                ...
                                <p>
                                    ...
                                    <span>سنوات الخبرة: <?php if($r_job->experience == 6): ?> More than <?php endif; ?> <?php echo $r_job->experience; ?></span>
                ...
                <?php foreach($search as $job): ?>
                    <li class="wow fadeIn" data-wow-delay=".2s" data-wow-duration="1s">
                        ...
                        <img  src='<?php echo asset("$job->image"); ?>' alt="<?php echo $job->ar_title; ?>"></a>
                         <div class="free">
                            <a href='<?php echo URL::to("jobs/$job->id"); ?>'>

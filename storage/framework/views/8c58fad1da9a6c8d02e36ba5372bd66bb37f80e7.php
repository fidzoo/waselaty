            ...
            <div class="content col-lg-9 col-md-9 col-sm-9">
                <div class="latest-order-bar">
                    ...
                    <select class="pull-right" name="order" id="order">
                        ...
                        <option value="1">وظائف خدمية</option>
                        <option value="2">وظائف مهنية</option>
                        <option value="3">أحدث الوظائف</option>
                        <option value="4">أقدم الوظائف</option>
                        <option value="5">الأكثر خبرة</option>
                        <option value="6">الأقل خبرة</option>
                    </select>
                </div>
                <div class="clearfix"></div>
                <ul class="jobs">

        ...
        <nav class="navbar-default navbar-side" role="navigation">
            ...
            <?php if(Session::get('role') == 'super'): ?>                    
                    ...
                    <li>
                        ...
                        <ul class="nav nav-second-level">
                            <li>
                             <a href="<?php echo e(URL::to('site-content')); ?>"><i class="fa fa-cube" aria-hidden="true"></i> Update Polices </a>  
                            </li>
                            <li>
                              <a href="<?php echo e(URL::to('back-n-social')); ?>"><i class="fa fa-cube" aria-hidden="true"></i> Slider & Social Media</a>
                            </li>
                        </ul>
                    </li>
            <?php endif; ?>                   

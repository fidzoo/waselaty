            ...
            <div class="content col-lg-9 col-md-9 col-sm-9">
                    ...
                    <li class="wow fadeIn" data-wow-delay=".2s" data-wow-duration="1s">
                        ...
                        <div class="col-lg-8 last col-md-8">
                            ...
                            <ul class="details">
                                ...
                                <li>Experience years : <?php echo $job->experience; ?></li>
                ...
                <ul class="jobs">
                    <?php foreach($relate_jobs as $re_job): ?>
                        ...
                        <?php endif; ?>
                    <li class="wow fadeIn" data-wow-delay=".2s" data-wow-duration="1s">
                        <div class="col-lg-2 col-md-2"><img src='<?php echo asset("$re_job->image"); ?>' alt="<?php echo $re_job->en_title; ?>"> </div>

...
<?php echo Form::select('categories[]', $cat_ar, $selected, ['multiple' => 'multiple', 'class'=>'form-control', 'disabled']); ?><br>
<?php echo Form::label('البلد'); ?>

<?php echo Form::select('country', $country_ar, $job->country_id, ['class'=>'form-control', 'disabled']); ?><br>

            ...
            <div class="content col-lg-9 col-md-9 col-sm-9">
                ...
                <ul class="jobs">
                    <li class="wow fadeIn" data-wow-delay=".2s" data-wow-duration="1s" style="overflow: visible;">
                        ...
                        <img id="zoom_01"  src='<?php echo asset("$job->image"); ?>' data-zoom-image='<?php echo asset("$job->image"); ?>' alt="job-image"> </div>
                        ...
                        <div class="col-lg-8 last col-md-8">
                            ...
                            <ul class="details">
                                ...
                                <li>سنوات الخبرة : <?php if($job->experience == 6): ?> أكثر من <?php endif; ?> <?php echo $job->experience; ?></li>
                                <li>الجنس : <?php echo $gender; ?></li>
                                <?php if($job_owner->user_group == 'company'): ?>
                                <li>الشركة : <?php echo $job_owner->company->ar_company; ?></li>
                                <?php endif; ?>
                                <li>الهاتف : <?php echo $job->phone; ?></li>
                                <li class="mapp">تجدنا هنا : <?php echo $job->map; ?></li>
                            </ul>
                        </div>
                        <div class="clearfix"></div>
                        <hr>
                        <div class="job-details">
                         ...
                         <h4>الجوال : <?php echo $job->mobile; ?></h4>

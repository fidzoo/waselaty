            ...
            <div class="content col-lg-9 col-md-9 col-sm-9">
                ...
                <?php foreach($rank_search as $r_job): ?>
                    <li class="wow fadeIn" data-wow-delay=".2s" data-wow-duration="1s">
                        <div class="col-lg-2 col-md-2"><img src='<?php echo asset("$r_job->image"); ?>' alt="<?php echo $r_job->en_title; ?>">
                ...
                <?php foreach($search as $job): ?>
                    <li class="wow fadeIn" data-wow-delay=".2s" data-wow-duration="1s">
                        <div class="col-lg-2 col-md-2"><img src='<?php echo asset("$job->image"); ?>' alt="<?php echo $job->en_title; ?>">
                        </div>
                        <div class="col-lg-8 col-md-8">

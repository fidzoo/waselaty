        ...
        <nav>
            ...
            <div class="all-left">
                ...
                <div class="drop-nav">
                    ...
                    <?php else: ?>
                    <li class="account"><a href='<?php echo URL::to("jobs-edit"); ?>'><i class="fa fa-user"></i>حسابي</a></li>
                    <li class="account"><a href='<?php echo URL::to("logout"); ?>'><i class="fa fa-user"></i>تسجيل الخروج</a></li>
                    <?php endif; ?>
                        <li>
            ...
            <div class="container">
                <div class="row wow fadeIn" data-wow-delay=".4s" data-wow-duration="2s">
                    ...
                    <ul class="social-icons">
                        <a href='<?php echo URL::to(social("facebook")); ?>' target="_blank">
...
<script src='<?php echo asset("assets/js/jquery.elevatezoom.js"); ?>'></script>
<script>
